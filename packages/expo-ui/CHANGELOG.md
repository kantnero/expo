...
- [android] Added `Anchor` slot, `readOnly`, `enabled`, and `TrailingIcon` slot to `TextInput`. ([#44201](https://github.com/expo/expo/pull/44201) by [@vonovak](https://github.com/vonovak))
